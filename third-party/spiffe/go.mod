module github.com/tommy351/kubernetes-models-ts/third-party/spiffe

go 1.26.2

tool github.com/spiffe/spire/support/k8s/k8s-workload-registrar/mode-crd/api/spiffeid/v1beta1
