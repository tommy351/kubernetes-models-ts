...
- [#254](https://github.com/tommy351/kubernetes-models-ts/pull/254) [`c4e485a`](https://github.com/tommy351/kubernetes-models-ts/commit/c4e485aaf9b717fbb4ab7312db87e5d975f8a2d4) Thanks [@eddiewentw](https://github.com/eddiewentw)! - Upgrade CRDs to v1.7.2. Drop support for `config.gateway.envoyproxy.io` CRDs used in Envoy Gateway v0.5.
