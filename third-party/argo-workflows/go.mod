module github.com/tommy351/kubernetes-models-ts/third-party/argo-workflows
...
tool github.com/argoproj/argo-workflows/v4/pkg/apis/workflow/v1alpha1

require (
	github.com/argoproj/argo-workflows/v4 v4.0.5 // indirect
