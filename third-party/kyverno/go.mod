module github.com/tommy351/kubernetes-models-ts/third-party/kyverno
...
tool (
	...
	github.com/kyverno/kyverno/api/kyverno/v2
...
require (
	...
	github.com/kyverno/kyverno v1.18.0 // indirect
