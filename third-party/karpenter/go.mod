module github.com/tommy351/kubernetes-models-ts/third-party/karpenter
...
require (
	...
	github.com/aws/karpenter-provider-aws v1.12.1 // indirect
	...
	sigs.k8s.io/karpenter v1.12.0 // indirect
