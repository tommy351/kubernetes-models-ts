module github.com/tommy351/kubernetes-models-ts/third-party/thanos-operator

go 1.26.2

tool github.com/banzaicloud/thanos-operator/pkg/sdk/api/v1alpha1

require (
	emperror.dev/errors v0.8.0 // indirect
	github.com/banzaicloud/operator-tools v0.26.0 // indirect
	github.com/banzaicloud/thanos-operator/pkg/sdk v0.3.7 // indirect
