module github.com/tommy351/kubernetes-models-ts/third-party/rabbitmq-messaging-topology-operator
...
require (
	...
	github.com/rabbitmq/messaging-topology-operator v1.19.1 // indirect
