module github.com/tommy351/kubernetes-models-ts/third-party/grafana-agent-operator

go 1.26.2

tool github.com/grafana/agent/pkg/operator/apis/monitoring/v1alpha1
...
require (
	...
	github.com/grafana/agent v0.40.5 // indirect
