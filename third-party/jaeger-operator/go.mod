module github.com/tommy351/kubernetes-models-ts/third-party/jaeger-operator

go 1.26.2

tool github.com/jaegertracing/jaeger-operator/apis/v1
...
require (
	...
	github.com/jaegertracing/jaeger-operator v1.65.0 // indirect
