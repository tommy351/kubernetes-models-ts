module github.com/tommy351/kubernetes-models-ts/third-party/redis-operator

go 1.26.2

tool (
	github.com/OT-CONTAINER-KIT/redis-operator/api/redis/v1beta2
...
require (
	github.com/OT-CONTAINER-KIT/redis-operator v0.24.0 // indirect
