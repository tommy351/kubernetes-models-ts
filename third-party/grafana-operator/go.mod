module github.com/tommy351/kubernetes-models-ts/third-party/grafana-operator
...
require (
	...
	github.com/grafana-operator/grafana-operator/v4 v4.8.0 // indirect
	github.com/grafana/grafana-openapi-client-go v0.0.0-20251202103709-7ef691d4df1d // indirect
	github.com/grafana/grafana-operator/v5 v5.22.2 // indirect
